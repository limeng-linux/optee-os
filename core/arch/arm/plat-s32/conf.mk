...
# to map this configuration into its memory
...
CFG_UBOOT_SIZE ?= 	0x00800000 # 8MB
CFG_TEE_SIZE ?= 	0x01600000 # 22MB

# Place the TZ Mem Area at the end of the first DRAM bank,
# just before the Secure Monitor Mem Area and U-Boot (BL33) Area
